# Dockerfile content to paste into the file you just created

# Stage 1: Build the Spring Boot application using a Maven image with JDK
...
# IMPORTANT: Replace 'votingapp-0.0.1-SNAPSHOT.jar' with your actual JAR name
# (e.g., from your pom.xml artifactId-version.jar, or check your local 'target/' folder)
